 ...
 *
 * Serves the repository root so parser/v0.3/web/index.html can reach the real files it depends on
 ...
 *
 *   node parser/v0.3/serve.js                 http://localhost:8080/parser/v0.3/web/index.html
 *   node parser/v0.3/serve.js --port 9000
 *   node parser/v0.3/serve.js --open          also launch the default browser
 *   node parser/v0.3/serve.js --host 0.0.0.0  listen on every interface (default: localhost only)
 *
 * Ctrl-C to stop.
 */
...
const ENTRY='/parser/v0.3/web/index.html';
