# v0.5 Summary: First Read-Only Geometry Parser & Viewer
...
This is implementation work, not a new research experiment. See `v0.5/README.md` for full architecture rationale and scope.
...
- Per-face cross-check: all 1,172 `(file, mp)` pairs in the v0.4.5 reference JSON match the v0.5 parser's output exactly on `edgeCount`, `vertexCount`, and `secCount`.
...
1. v0.5 parser reproduces 1,172/1,172 faces from the v0.4.5/v0.4.6 corpus exactly (marker offset, edge count, vertex count, section count).
...
- `v0.5/README.md`, `v0.5/SUMMARY.md` (this file), `v0.5/package.json`
- `v0.5/src/parser-core.js`, `v0.5/src/node-cli.js`
- `v0.5/web/index.html`, `v0.5/web/viewer.js`
- `v0.5/test/run-corpus-tests.js`, `v0.5/test/compare-with-reference.js`
- `knowledge/evidence/2026-08-13_v0.5-parser-validation.md`

No file outside `v0.5/` (other than the append-only knowledge-base updates listed in the evidence file) was modified. No file under any prior version directory (`v0.2.x`-`v0.4.6`) was touched.
