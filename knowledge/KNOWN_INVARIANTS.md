...
**Corrected 2026-09-20.** The entropy measurement was right (H = 7.93–8.00 raw) but the
...
read — but it is no longer opaque. See [CONTAINER_AND_STREAMS.md](CONTAINER_AND_STREAMS.md) §5.
